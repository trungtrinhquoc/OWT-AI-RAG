...
responseFromChatbot = chatbot_with_message_history.invoke(
    [HumanMessage(content="Mi name is Trung Trịnh.")],
    config=session2,
)

print("\n----------\n")

print("Mi name is Trung Trịnh. (in session2)")
...
responseFromChatbot = chatbot_with_message_history.invoke(
    [HumanMessage(content="My favorite vehicles are SH scooters.")],
    config=session1,
)

print("\n----------\n")

print("My favorite vehicles are SH scooters. (in session1)")
